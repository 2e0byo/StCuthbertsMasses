...
\newcommand{\office}{%
  In medio ecclesiae aperujt os ejus, et implevit
  eum Dominus spiritu sapientiae et intellectus: stolam
  gloriae induit eum. Jucunditatem
  et exsultationem thesaurizavit super eum. Gloria Patri.
}
...
\newcommand{\responsory}{%
  ...
  Tu es sacerdos in aetemum secundum ordinem Melchisedech.\v\ Dixit Dominus Domino meo: Sede a dextris meis.
  Alleluia, alleluia.\v\ Inveni David servum meum: oleo
  sancto meo unxi eum. Alleluia.
}
...
\newcommand{\offertory}{%
  Justus ut palma florebit: sicut cedrus, quae
...
\newcommand{\secret}{%
  \l{Accepta sit in conspectu tuo, Domine, nostra
    devotio, ut ejus nobis fiat supplicatione salutaris, pro cujus
    solemnitate defertur.}
  \e{May our devotion be so acceptable in Your
    sight, O Lord, that at the pleading of him on whose
    feast day it is offered, it may further our salvation;
    through our Lord.}
  \per
}

\newcommand{\communion}{%
  Beatus servus, quern cum venerit dominus,
  invenerit vigilantem. Amen dico vobis, super omnia bona
  sua constituet eum.
}
...
\newcommand{\postcommunion}{%
  ...
  \e{%
    Grant to Your faithful, we beseech You, O Lord, ever to be gladdened by the veneration of Your saints, and to be fortified by their interceding prayer: through out Lord.
  }
  \per
}
