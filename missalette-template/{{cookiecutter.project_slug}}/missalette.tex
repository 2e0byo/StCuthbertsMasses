...
\gregorioscore{kyrie.gtex}

\section{Gloria}
\red{Immediately after the Kyrie:}
\gregorioscore{gloria.gtex}

\section{Collect}
\gregorioscore{dominus_vobiscum.gtex}
\black{\collect}
\gregorioscore{amen.gtex}
...
\gregorioscore{amen.gtex}
\gregorioscore{pax_domini.gtex}
\gregorioscore{agnus.gtex}
...
\vfill
% {% endraw %}
Typeset by \VAR{cookiecutter.feast_name} in ten-point Palatino.  Translations from the
